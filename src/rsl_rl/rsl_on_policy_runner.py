...
import rsl_rl
from .rsl_bpo import BPO
from rsl_rl.algorithms import PPO
from .rsl_actor_critic import BPOActorCritic, BPOActorCriticRecurrent
...
class BPOOnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        # TODO: add BPO
        if self.alg_cfg["class_name"] == "PPO" or self.alg_cfg["class_name"] == "BPO":
        ...
        policy: ActorCritic | ActorCriticRecurrent | BPOActorCritic | BPOActorCriticRecurrent = policy_class(
        ...
        for it in range(start_iter, tot_iter):
            ...
            with torch.inference_mode():
                ...
                if self.training_type == "rl":
                    ...
                    # TODO: remember the last privileged_obs
                    self.alg.last_privileged_obs = privileged_obs
